  ...
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('publishers', [
      ...
      },
      {
        ...
        created_at: new Date("2024-09-10 11:00:00"),
        updated_at: new Date("2024-09-10 11:00:00"),
      },
      {
      ...
      },
      {
        ...
        created_at: new Date("2024-09-10 15:00:00"),
        updated_at: new Date("2024-09-10 15:00:00"),
      },
      {
        name: "Geoffrey Bles",
        address: "United Kingdom",
